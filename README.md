...
Package license: BSD-2-Clause AND MIT AND LicenseRef-CC0-1.0

Summary: Library for parsing command line arguments and config files

Development: https://forge.hekkelman.net/maarten/mcfp.git
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libmcfp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libmcfp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `libmcfp` available on your platform:
...
```
pixi search libmcfp --channel conda-forge
```
